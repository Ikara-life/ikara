      ...
      <section id="apply" className="section-padding bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 animate-fade-in [animation-delay:0.4s]">
              <div className="bg-white p-8 rounded-xl shadow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <span
                      className="flex-shrink-0 w-8 h-8 bg-black text-white rounded-full flex items-center justify-center">
                    1
                  </span>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                  <span
                      className="flex-shrink-0 w-6 h-6 bg-black text-white rounded-full flex items-center justify-center">
                    ✓
                  </span>
                    <span className="text-lg text-gradient">
            ...
            <blockquote
                className="text-xl md:text-2xl font-medium text-center mt-12 animate-fade-in [animation-delay:0.6s] italic text-gradient">
