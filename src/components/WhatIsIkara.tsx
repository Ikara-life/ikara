    ...
    <section id="about" className="section-padding bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 animate-fade-in [animation-delay:0.4s]">
            ...
            <Card className="bg-white border-gray-200 hover:border-gray-300 transition-colors shadow-sm">
              <CardContent className="p-6 text-center flex flex-col items-center space-y-4">
                ...
                <p className="text-lg font-medium text-gray-900">
                  This isn't just a getaway. It's a glimpse of how life could
                  be.
                </p>
              </CardContent>
            </Card>
          ...
          <blockquote className="text-xl md:text-2xl font-medium text-center mt-12 animate-fade-in [animation-delay:0.6s] italic text-gray-900">
